<template>
  <div>
    ...
    <el-dialog title="指派FSE" width="30%" v-model="detailVisible" :close-on-click-modal="false">
      <el-form :model="formDetails" ref="formRefDetails" label-width="150" :rules="rules">
        <el-form-item label="FSE工程师名称" prop="aaa">
          <el-input v-model="formDetails.aaa" placeholder="请输入FSE工程师名称">
            <template #append>
              <el-button><i-ep-Search /></el-button>
            </template>
          </el-input>
        ...
        <el-form-item label="FSE work center" prop="bbb">
          <el-input v-model="formDetails.bbb" disabled placeholder="自动填入" clearable />
        </el-form-item>
        <el-form-item label="FSE storage location" prop="ccc">
          <el-input v-model="formDetails.ccc" disabled placeholder="自动填入" clearable />
        </el-form-item>
      </el-form>
      <template #footer>
    ...
    <!-- <el-dialog title="未关闭SO数量" width="50%" v-model="visibleSo" :close-on-click-modal="false">
            <el-table size="small" :data="tableData" style="width: 100%; margin-bottom: 20px" max-height="190"
...
// const tableData = [
//     { aaa: 'xxxxx', bbb: '状态', ccc: "SM02", ddd: '李四', eee: "2023-08-22 10:20:23", fff: '2023-08-25 15:24:23', ggg: '一号工程师', hhh: "详情", iii: 'xxxxxx' },
//     { aaa: 'xxxxx', bbb: '状态', ccc: "SM02", ddd: '李四', eee: "2023-08-22 10:20:23", fff: '2023-08-25 15:24:23', ggg: '一号工程师', hhh: "详情", iii: 'xxxxxx' },
// ]
// const handleNum = () => {
